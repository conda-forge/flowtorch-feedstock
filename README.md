...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/flowtorch-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14766&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/flowtorch-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `flowtorch` can be installed with:

```
conda install flowtorch
```

It is possible to list all of the versions of `flowtorch` available on your platform with:
